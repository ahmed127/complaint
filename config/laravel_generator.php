...
return [
    ...
    */
    ...
    'path' => [
        ...
        'menu_file'         => resource_path('views/adminPanel/layouts/partials/menu.blade.php'),
    ],
    ...
    */
    ...
    'prefixes' => [
        ...
        'route' => 'adminPanel',  // e.g. admin or admin.shipping or admin.shipping.logistics

        'namespace' => 'AdminPanel',  // e.g. Admin or Admin\Shipping or Admin\Shipping\Logistics

        'view' => 'adminPanel',  // e.g. admin or admin/shipping or admin/shipping/logistics
    ],
